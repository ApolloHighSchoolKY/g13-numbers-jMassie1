...
public class NumberAnalyzer
{
	...
	{
		//Make the list exist first || it was created in the default but not in the modified constructor
		list = new ArrayList<Number>();
	...
	public int countEvens()
	{
		...
		for(Number evenNum: list) 
		{
			if(evenNum.isOdd() == false)
				evenCount++;
		}
	...
	public int countPerfects()
	{
		...
		for(Number perfects: list)
		{
			if(perfects.isPerfect())
				perfectCount++;
		}
